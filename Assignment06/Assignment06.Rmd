...
# What about the summary stats for the rest of the variables? (-4)
# What about sd/var? (-5)
...
`I do not see explanations about the violations of the assumptions (-25)`
...
`Missing some sort of transformations to help. (-3)`
`Didn't check GM assumptions after changes. (-5)`
